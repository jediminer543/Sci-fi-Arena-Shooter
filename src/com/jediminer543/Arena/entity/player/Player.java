...
public class Player implements Tickable
{
	...
	{
		TextHandeler.drawMainStringHUD(10, 12, "Debug Info", Color.cyan);
		TextHandeler.drawMainStringHUD(10, 24, " Player Location:", Color.cyan);
		TextHandeler.drawMainStringHUD(10, 36, "  X = " + position.x, Color.cyan);
		TextHandeler.drawMainStringHUD(10, 48, "  Y = " + position.y, Color.cyan);
		TextHandeler.drawMainStringHUD(10, 60, "  Z = " + position.z, Color.cyan);
